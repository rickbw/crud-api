 ...
 * {@link DeletableSpec}s. It tests basic contracts that should hold true
 * for all implementations.
 */
public abstract class DeletableSpecTest<RESP> extends ResourceTest {
    ...
    public void responsesFromRepeatedDeletedAreTheSame() {
        // given:
        final DeletableSpec<RESP> resource = createDefaultResource();
    ...
    @Override
    protected abstract DeletableSpec<RESP> createDefaultResource();
