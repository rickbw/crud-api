...
public class DeletableProviderRetryTest
...
//    private static final String SUCCESS_RESPONSE = "Hello, World";
    ...
    public void retryZeroTimesReturnsSameObject() {
        // given:
        final DeletableProvider<Object, Object> expected = super.createDefaultProvider();

        // when:
        final DeletableProvider<Object, Object> actual = expected.retry(0);
    ...
    public void retryNegativeTimesThrows() {
        // given:
        final DeletableProvider<Object, Object> provider = super.createDefaultProvider();
