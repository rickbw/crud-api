...
/**
 * Tests the nested subclass of {@link Deletable} that handles
 * retries.
 */
public class DeletableRetryTest extends DeletableTest {
...
//    private static final String SUCCESS_RESPONSE = "Hello, World";
    ...
    public void retryZeroTimesReturnsSameObject() {
        // given:
        final Deletable<Object> expected = super.createDefaultResource();

        // when:
        final Deletable<Object> actual = expected.retry(0);
    ...
    public void retryNegativeTimesThrows() {
        // given:
        final Deletable<Object> provider = super.createDefaultResource();
