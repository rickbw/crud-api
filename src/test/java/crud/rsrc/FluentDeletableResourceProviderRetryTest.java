...
public class FluentDeletableResourceProviderRetryTest
...
//    private static final String SUCCESS_RESPONSE = "Hello, World";
    ...
    public void retryZeroTimesReturnsSameObject() {
        // given:
        final FluentDeletableResourceProvider<Object, Object> expected = super.createDefaultProvider();

        // when:
        final FluentDeletableResourceProvider<Object, Object> actual = expected.retry(0);
    ...
    public void retryNegativeTimesThrows() {
        // given:
        final FluentDeletableResourceProvider<Object, Object> provider = super.createDefaultProvider();
