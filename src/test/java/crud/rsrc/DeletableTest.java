...
/**
 * Tests those methods of {@link Deletable} that don't require
 ...
 */
public class DeletableTest extends DeletableSpecTest<Object> {

    protected final DeletableSpec<Object> mockDelegate = mock(DeletableSpec.class);
    ...
    public void fluentResourceNotEqualDelegate() {
        // given:
        final Deletable<Object> resource = createDefaultResource();
    ...
    public void fromResourceReturnsSameObject() {
        ...
        // when:
        final Deletable<Object> wrappedRsrc = Deletable.from(origRsrc);
    ...
    public void equalResourcesHaveEqualFunctions() {
        // given:
        final Deletable<Object> resource1 = createDefaultResource();
        final Deletable<Object> resource2 = createDefaultResource();
    ...
    @Override
    protected Deletable<Object> createDefaultResource() {
        return Deletable.from(this.mockDelegate);
    }
