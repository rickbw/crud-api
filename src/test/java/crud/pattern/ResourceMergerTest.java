...
public abstract class ResourceMergerTest {
    ...
    protected final GettableSpec<Object> mockReader = mock(GettableSpec.class);
    ...
    protected abstract ResourceMerger<Object> createDefaultMerger(GettableSpec<Object> reader);
