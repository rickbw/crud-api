 ...
 * retries.
 */
public class FluentWritableResourceRetryTest extends FluentWritableResourceTest {
...
//    private static final String SUCCESS_RESPONSE = "Hello, World";
    ...
    public void retryZeroTimesReturnsSameObject() {
        // given:
        final FluentWritableResource<Object, Object> expected = super.createDefaultResource();

        // when:
        final FluentWritableResource<Object, Object> actual = expected.retry(0);
