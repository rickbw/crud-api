...
public final class DeferredDeletableResource<RESPONSE>
implements AsyncDeletableResource<RESPONSE> {

    private final SyncDeletableResource<RESPONSE> delegate;
    ...
    public DeferredDeletableResource(
            final SyncDeletableResource<RESPONSE> delegate,
