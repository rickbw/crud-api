 ...
 * {@link ReadableSpec} and a {@link WritableSpec}) can extend
 * multiple sub-interfaces of this interface (e.g. both
 * {@link ReadableProviderSpec} and {@link WritableProviderSpec}) by
 * overriding the return type of {@link #get(Object)}.
 */
public interface ResourceProviderSpec<KEY> {
